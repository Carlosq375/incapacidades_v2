       ...
       //Ejecutar funciones
        ...
        //Funcion para para que se ajuste a pantalla haciendo un resize a la pagina
        ...
        /*Ejecutamos la funcion para que no se tenga que actualizar la pagina
          sino que este actualizada*/
        anchoPagina();
        
        //Funcion para hacer el llamado del formulario inicio de sesión por medio del boton
        ...
        //Funcion para hacer el llamado del formulario por medio del boton registro 
        function registro(){
                if(window.innerWidth >850){
